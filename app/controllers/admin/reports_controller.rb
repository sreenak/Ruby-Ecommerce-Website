class Admin::ReportsController < AdminController
  def index
    ...
    best_sale = ActiveRecord::Base.connection.execute(sql1)
    ...
    worst_sale = ActiveRecord::Base.connection.execute(sql2)
    ...
    weekly_sale = ActiveRecord::Base.connection.execute(sql3)
    ...
    monthly_sale = ActiveRecord::Base.connection.execute(sql4)
