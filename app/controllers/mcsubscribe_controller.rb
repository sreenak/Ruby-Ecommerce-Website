    ...
    if !email.blank?
      ...
      begin
        ...
        respond_to do |format|  
          format.json{render :json => {:message => "Almost finished... We need to confirm your email address. To complete the subscription process, please click the link in the email we just sent you.."}}
        end
